...
var handleDomo = function handleDomo(e) {
    ...
    if ($("#domoName").val() == '' || $("domoAge").val() == '' || $("domoIQ").val() == '') {
...
var DomoForm = function DomoForm(props) {
    return React.createElement(
        ...
        React.createElement("input", { id: "domoIQ", type: "text", name: "iq", placeholder: "Domo IQ" }),
...
var DomoDeleteForm = function DomoDeleteForm(props) {
    return React.createElement(
        "form",
        { id: "domoDeleteForm", name: "domoDeleteForm",
...
var setup = function setup(csrf) {
    ...
    ReactDOM.render(React.createElement(DomoDeleteForm, { csrf: csrf }), document.querySelector("#deleteDomo"));
